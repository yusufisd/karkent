                        ...
                        <div class="card-body py-5">
                            ...
                            <form action="{{ route('admin.user.store') }}" method="POST" id="user_form" class="form">
                                ...
                                <div class="card-body px-3 py-9">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="row">
                                                        <!--begin::Col-->
                                                        <div class="col-lg-12 fv-row">
                                                            <input id="user_no" type="number" name="phone"
                                                                class="form-control form-control-lg form-control-solid mb-lg-0 mb-3"
                                                                value="" />
                                                        </div>
                                                        <!--end::Col-->
                                    ...
                                    <div class="row mb-6">
                                        <!--begin::Label-->
                                        <label class="col-lg-2 col-form-label fw-bold fs-6 required ps-5">Dil</label>
                                        <!--end::Label-->
                                        <!--begin::Col-->
                                        <div class="col-lg-4">
                                            <!--begin::Row-->
                                            <div class="row">
                                                <!--begin::Col-->
                                                <div class="col-lg-12 fv-row">
                                                    <select name="role_id" aria-label="Seçiniz" data-control="select2"
                                                        data-placeholder="Seçiniz..."
                                                        class="form-select form-select-solid form-select-lg fw-semibold">
                                                        @foreach ($roles as $item)
                                                            <option value="{{ $item->id }}">
                                                                {{ strtoupper($item->rol_adi) }}</option>
                                                        @endforeach
