                            ...
                            <!--begin::Form-->
                                    <form action="{{route('admin.user.update',$data->id)}}" method="POST" id="user_form" class="form">
                                        ...
                                        <div class="card-body px-3 py-9">
                                                        ...
                                                        <div class="col-lg-8">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12 fv-row">
                                                                    <input type="text" id="user_name" name="name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" value="{{$data->name}}" />
                                                                </div>
                                                                <!--end::Col-->
                                                            </div>
                                                            <!--end::Row-->
                                                    ...
                                                    <div class="row ms-10">
                                                        ...
                                                        <div class="col-lg-8">
                                                            ...
                                                            <div class="row">
                                                                <!--begin::Col-->
                                                                <div class="col-lg-12 fv-row">
                                                                    <input type="text" id="user_surname" name="surname" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" value="{{$data->surname}}" />
                                                                </div>
                                                                <!--end::Col-->
                                                            </div>
                                                            <!--end::Row-->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-8">
                                                            ...
                                                            <div class="row">
                                                                <!--begin::Col-->
                                                                <div class="col-lg-12 fv-row">
                                                                    <input id="user_no" type="number" name="phone" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" value="{{$data->phone}}" />
                                                                </div>
                                                                <!--end::Col-->
                                                            </div>
                                                            <!--end::Row-->
                                                    ...
                                                    <div class="row ms-10">
                                                        ...
                                                        <div class="col-lg-8">
                                                            ...
                                                            <div class="row">
                                                                <!--begin::Col-->
                                                                <div class="col-lg-12 fv-row">
                                                                    <input type="email" id="user_email" name="email" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" value="{{$data->email}}" />
                                                                </div>
                                                                <!--end::Col-->
                                                            </div>
                                                            <!--end::Row-->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-8">
                                                            ...
                                                            <div class="row">
                                                                <!--begin::Col-->
                                                                <div class="col-lg-12 fv-row">
                                                                    <input id="user_password" type="password" name="password" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" readonly value="******" />
                                                                </div>
                                                                <!--end::Col-->
                                                            </div>
                                                            <!--end::Row-->
                                                    ...
                                                    <div class="row ms-10">
                                                        ...
                                                        <div class="col-lg-8">
                                                            ...
                                                            <div class="row">
                                                                <!--begin::Col-->
                                                                <div class="col-lg-12 fv-row">
                                                                    <input type="password" id="user_password_again" name="password_confirm" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" readonly value="******" />
                                                                </div>
                                                                <!--end::Col-->
                                                            </div>
                                                            <!--end::Row-->
                                            ...
                                            <div class="row mb-6">
                                                <!--begin::Label-->
                                                <label class="col-lg-2 col-form-label fw-bold fs-6 ps-5 required">Rol</label>
                                                <!--end::Label-->
                                                <!--begin::Col-->
                                                <div class="col-lg-4">
                                                    <!--begin::Row-->
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12 fv-row">
                                                            <select name="role_id" aria-label="Seçiniz" data-control="select2" data-placeholder="Seçiniz..." class="form-select form-select-solid form-select-lg fw-semibold">
                                                                ...
                                                                <option {{$data->role_id == $item->id ? 'selected' : ''}} value="{{$item->id}}">{{strtoupper($item->rol_adi)}}</option>
                                            ...
                                            <div class="row mb-0">
                                                ...
                                                <div class="col-lg-4 d-flex align-items-center">
                                                    <div class="form-check form-check-solid form-switch form-check-custom fv-row">
                                                        <input class="form-check-input w-50px h-25px" type="checkbox" id="allowuser" {{$data->status == 1 ? 'checked' : ''}} />
