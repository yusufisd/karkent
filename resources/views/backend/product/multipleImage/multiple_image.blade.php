                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                        ...
                                        <a type="button" class="btn btn-outline btn-outline-success"
                                            href="{{ route('admin.product.multipleImage_add', $id) }}">
                                            ...
                                            <!--end::Svg Icon--> {{ __('msg.resim') }} {{ __('msg.ekle') }} </a>
                                        <!--end::Add user-->
                                    </div>
                                    <!--end::Toolbar-->
                                </div>
                                    ...
                                    <table id="blog_categories_table" class="gy-7 gx-7 table">
                                        <thead>
                                            <tr class="fw-bold fs-6 text-gray-800">
                                                ...
                                                <th style="text-align: center"> {{ __('msg.resim') }} <i
        ...
        function destroy(d) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "{{ route('admin.product.multipleImage_destroy') }}/{{$id}}?path=" + d;
                }
            })
        }
    </script>
