    ...
    <div id="kt_app_toolbar" class="app-toolbar py-lg-10 py-3">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center me-3 flex-wrap">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-primary fw-bold fs-3 flex-column justify-content-center my-0"> {{__('msg.logo')}} {{__('msg.yönetim')}} </h1>
                <!--end::Title-->
            </div>
            <!--end::Page title-->
        </div>
                                ...
                                <table id="slider_table" class="gy-7 gx-7 table">
                                    <thead>
                                        <tr class="fw-bold fs-6 text-gray-800">
                                            ...
                                            <th class="pe-7 text-center"> {{ __('msg.durum') }} <i
                                                    class="fa fa-sort ms-3"></i></th>
                                            ...
                                            <tr class="align-middle">
                                                ...
                                                <td>
                                                    <div
                                                        ...
                                                        <input class="form-check-input w-50px h-25px" id="point"
                                                            type="checkbox" id="slider_status_1"
...
@section('script')
    ...
    <script>
        function status_change(d) {
            window.location.href = "{{ route('admin.sponsor.status_change') }}/" + d
        }
